...
# Set parameters
building_observations = 10000  # Number used by methods of the FactorGraph to find appropriate factors for each facet.
...
observations = 100  # number of samples, i.e., number of data points or number of sites
...
dir_name = 'sc_20_nodes'
data_name = 'data_'+building_constraint.lower()
...
one_simplices = [[3, 4], [3, 5], [3, 15], [4, 5], [4, 8], [5, 6], [5, 7], [5, 15], [6, 7], [6, 15], [6, 17], [8, 10],
                 [9, 10], [9, 11], [10, 11], [10, 13], [11, 12], [18, 19]]

two_simplices = [[0, 1, 2], [0, 1, 3], [0, 2, 3], [1, 2, 3], [7, 8, 9], [12, 13, 14], [15, 16, 17]]

facet_list = one_simplices + two_simplices
...
#factorgraph = FactorGraph(facet_list, N=building_observations, alpha=alpha, build_sc=build_sc,
#                          building_constraint=building_constraint)
